...
public class Produto {
  ...
  @NotNull
  @Size(min = 10, max = 20)
  @Column(name = "codigo_de_barras", nullable = false, length = 20, unique = true)
  ...
  public Produto(
      Integer id,
      @NotNull @Size(min = 3, max = 40) String nome,
      Categoria categoria,
      @NotNull @Size(min = 10, max = 20) Integer codigoDeBarras,
      Date dataFabricacao,
